...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = {\n  //controls\n  UP: \"UP\",\n  DOWN: \"DOWN\",\n  LEFT: \"LEFT\",\n  RIGHT: \"RIGHT\"\n};\n\n//# sourceURL=webpack:///./src/engine/events-list.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _eventsList = __webpack_require__(/*! ./events-list.js */ \"./src/engine/events-list.js\");\n\nvar _eventsList2 = _interopRequireDefault(_eventsList);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction Events() {\n  this.emit = function (enent) {};\n  this.subscribe = function (event, callback) {};\n};\n\nexports.default = new Events();\n\n//# sourceURL=webpack:///./src/engine/events.js?");
...
"use strict";
eval("\n\nvar _typeof = typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; };\n\nvar _events = __webpack_require__(/*! ./events.js */ \"./src/engine/events.js\");\n\nvar _events2 = _interopRequireDefault(_events);\n\nvar _eventsList = __webpack_require__(/*! ./events-list.js */ \"./src/engine/events-list.js\");\n\nvar _eventsList2 = _interopRequireDefault(_eventsList);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction Touch() {\n  var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;\n  var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;\n  var width = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;\n  var height = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;\n\n  this.x = typeof x === \"number\" ? x : 0;\n  this.y = typeof y === \"number\" ? y : 0;\n  this.width = typeof width === \"number\" ? width : 0;\n  this.height = typeof height === \"number\" ? height : 0;\n};\n\nfunction KeyBinding() {\n  //private properties\n  var _controls = [];\n\n  for (var event in _eventsList2.default) {\n    _controls.push({\n      keyCode: 0,\n      touch: new Touch(),\n      event: event\n    });\n  };\n  //private methods\n  var _findControlByEvent = function _findControlByEvent(event) {\n    var _iteratorNormalCompletion = true;\n    var _didIteratorError = false;\n    var _iteratorError = undefined;\n\n    try {\n      for (var _iterator = _controls[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n        var control = _step.value;\n\n        if (event === control.event) return control;\n      }\n    } catch (err) {\n      _didIteratorError = true;\n      _iteratorError = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion && _iterator.return) {\n          _iterator.return();\n        }\n      } finally {\n        if (_didIteratorError) {\n          throw _iteratorError;\n        }\n      }\n    }\n\n    ;\n    return false;\n  };\n\n  var _findControlByKeyCode = function _findControlByKeyCode(keyCode) {\n    var _iteratorNormalCompletion2 = true;\n    var _didIteratorError2 = false;\n    var _iteratorError2 = undefined;\n\n    try {\n      for (var _iterator2 = _controls[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n        var control = _step2.value;\n\n        if (keyCode === control.keyCode) return control;\n      }\n    } catch (err) {\n      _didIteratorError2 = true;\n      _iteratorError2 = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion2 && _iterator2.return) {\n          _iterator2.return();\n        }\n      } finally {\n        if (_didIteratorError2) {\n          throw _iteratorError2;\n        }\n      }\n    }\n\n    ;\n    return false;\n  };\n\n  var _findControlByTouch = function _findControlByTouch(touch) {\n    var _iteratorNormalCompletion3 = true;\n    var _didIteratorError3 = false;\n    var _iteratorError3 = undefined;\n\n    try {\n      for (var _iterator3 = _controls[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {\n        var control = _step3.value;\n\n        if (touch.x > control.touch.x && touch.y > control.touch.y && touch.x < control.touch.x + control.touch.width && touch.y < control.touch.y + control.touch.height) return control;\n      }\n    } catch (err) {\n      _didIteratorError3 = true;\n      _iteratorError3 = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion3 && _iterator3.return) {\n          _iterator3.return();\n        }\n      } finally {\n        if (_didIteratorError3) {\n          throw _iteratorError3;\n        }\n      }\n    }\n\n    ;\n    return false;\n  };\n  //public methods\n  this.bind = function (keyCode, event) {\n    var control = _findControlByEvent(event);\n    if (!control) return false;\n    switch (typeof keyCode === 'undefined' ? 'undefined' : _typeof(keyCode)) {\n      case \"number\":\n        control.keyCode = keyCode;\n        break;\n      case 'object':\n        if (!(keyCode instanceof Touch)) return false;\n        control.touch = keyCode;\n        break;\n      default:\n        return false;\n    };\n    return true;\n  };\n  this.getEvent = function (keyCode) {\n    var control = void 0;\n    switch (typeof keyCode === 'undefined' ? 'undefined' : _typeof(keyCode)) {\n      case \"number\":\n        control = _findControlByKeyCode(keyCode);\n        break;\n      case \"object\":\n        control = _findControlByTouch(keyCode);\n        break;\n    };\n    if (control) return control.event;\n    return false;\n  };\n};\n\nvar kb = new KeyBinding();\n\nkb.bind(37, _eventsList2.default.LEFT);\nkb.bind(38, _eventsList2.default.UP);\nkb.bind(39, _eventsList2.default.RIGHT);\nkb.bind(40, _eventsList2.default.DOWN);\nkb.bind(new Touch(0, 0, 100, 100), _eventsList2.default.DOWN);\n\nfunction init() {\n  document.addEventListener(\"keyup\", function (e) {\n    var event = kb.getEvent(e.keyCode);\n    console.log(event);\n    if (event) _events2.default.emit(event);\n  });\n  document.getElementById(\"canvas\").addEventListener(\"click\", function (e) {\n    var event = kb.getEvent({ x: e.x, y: e.y });\n    console.log(event);\n    if (event) _events2.default.emit(event);\n  });\n};\n\nmodule.exports = {\n  init: init,\n  bind: kb.bind,\n  Touch: Touch\n};\n\n//# sourceURL=webpack:///./src/engine/input.js?");
